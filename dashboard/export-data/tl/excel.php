...
$query = mysqli_query($link,"SELECT * FROM data_pendaftar INNER JOIN data_asal_sekolah ON data_pendaftar.id_pendaftar = data_asal_sekolah.id_siswa INNER JOIN status_pendaftaran ON data_pendaftar.id_pendaftar = status_pendaftaran.id_siswa WHERE status = 'tidak_lolos'");
$i = 2;
$no = 1;
...
// Rename worksheet
$spreadsheet->getActiveSheet()->setTitle('Data Peserta Tidak Lolos');
...
header('Content-Disposition: attachment;filename="Laporan_Data_Peserta_Tidak_Lolos.xlsx"');
