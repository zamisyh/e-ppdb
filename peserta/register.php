<?php 
    ...
    if (isset($_POST['btnSubmit']) === true) {
        ...
        $saveData = mysqli_query($link, "INSERT INTO users_admin (id_admin, kode_pendaftar, username, email, password, role) VALUES ('', '$kode_pendaftar', '$username', '$email', '$hashPassword', '$role')");
                                ...
                                <div class="card-block">
                                    ...
                                    <div class="form-group">
                                       <?php if (isset($success)): ?>
                                           ...
                                           Berhasil, copy dan simpan kode pendaftaran ini baik-baik <b><?= $kode_pendaftar; ?></b>
                                        </div>
                                       <?php endif ?>
                                       <?php if (isset($error)): ?>
                                    ...
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            <button type="submit" name="btnSubmit" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Register</button>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
